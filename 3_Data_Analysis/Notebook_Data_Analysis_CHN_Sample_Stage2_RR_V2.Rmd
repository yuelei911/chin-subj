...
## Save the special target population for exploration analyse

# save(Journal_special_target_population2,file =  "Journal_special_target_population2.RData")
```
...
In addition, I attempt to conduct an exploratory analysis on Hypothesis 3 using four age groups (<18, 18~40, 41~60, >61). Therefore, I will save the following age data.
```{r}
save(Journal_age2,BTS,WEIRD,file = "H3_age_exploration.RData")
```
...
save gender data for exploration analyse
```{r}
save(H1_gender_general,H2_gender_general,Census6_gender,file = "H2_gender_exploration.Rdata") ## data include papers, projects, and Census data.
```
...
save(H1_age_general,H1_PsyStages_bayes_general,H1_interval10_bayes_general,
     ...
     Census6_age_five5,Census6_age_PsyStages,Census6_age_interval10,
...
save region data for exploration analysis
```{r}
save(Journal_region_single,Journal_region_multiple,
     Census7_region,Census7_region_four,Census7_region_seven,
     CFPS2018_region,CFPS2018_region_four,CFPS2018_region_seven,
     H2_region_four_bayes,H2_region_seven_bayes,Region_map_color,
     China_province,China_region_four,China_region_seven,
     H2_region_four,H2_region_seven,Journal_region_general_tab2,
     file = "Journal_region.RData")
```
