...
I found moderate evidence for the $H_0$ that the college proportion from Chinese five journal data is comparable to that in the BTS data, with $Log(BF_{10})$ = `r H1_BF_edu_college$BF$LogBF10`.
...
I also found Anecdotal evidence for the $H_0$ that the high schools proportion from Chinese five journal data is comparable to that in the BTS data, with $Log(BF_{10})$ = `r H1_BF_edu_highschool$BF$LogBF10`.
...
For four regions, I also found very strong evidence for the $H_1$ that the BTS is different from that of Journal data, with $Log(BF_{10})$ = `r H1_BF_Journal_BTS_region_four$BF$LogBF10`, as well as equally the strong evidence for the seven regions $Log(BF_{10})$ = `r H1_BF_Journal_BTS_region_seven$BF$LogBF10`
...
For age within general population, I found the Bayesian multinomial test shows extremely strong evidence in foavor of $H_1$. PsyStages and interval10 are $Log(BF_{10})$ = `r H2_BF_age_Psystages_general$BF$LogBF10` and $Log(BF_{10})$ = `r H2_BF_age_interval10_general$BF$LogBF10` respectively.
...
High school: Census7($Log(BF_{10})$ = `r H2_BF_edu_highschool_Census7$BF$LogBF10`), CFPS2018($Log(BF_{10})$ = `r H2_BF_edu_highschool_CFPS2018$BF$LogBF10`)
...
H2_BF_Chinese_participants_CFPS2018_region_four <- BayesMultiNomial(dataset = H2_region_four_bayes,
                                          ...
                                          expected = "CFPS2018")
```
four regions: Journal vs Census7,$Log(BF_{10})$ =`r H2_BF_Chinese_participants_Census7_region_four$BF$LogBF10`
four regions: Journal vs CFPS2018,$Log(BF_{10})$ =`r H2_BF_Chinese_participants_CFPS2018_region_four$BF$LogBF10`
...
H2_BF_Chinese_participants_CFPS2018_region_seven <- BayesMultiNomial(dataset = H2_region_seven_bayes,
                                          ...
                                          expected = "CFPS2018")
```
seven regions: Journal vs Census7,$Log(BF_{10})$ =`r H2_BF_Chinese_participants_Census7_region_seven$BF$LogBF10`
seven regions: Journal vs CFPS2018,$Log(BF_{10})$ =`r H2_BF_Chinese_participants_CFPS2018_region_seven$BF$LogBF10`
