...
Suppl_BF_Abstract1_general_college_outside <- BayesMultiNomial(dataset = Journal_abstract1_report_general_bayes,
                                       ...
                                       expected = "Only college students")
```
Only college students as expected. Abstract1 for general population.
Only college students vs College students & other populations：$Log(BF_{10})$ = `r Suppl_BF_Abstract1_general_college_other$BF$LogBF10`.

Only college students vs Only sample outside colleges：$Log(BF_{10})$ = `r Suppl_BF_Abstract1_general_college_outside$BF$LogBF10`.
...
## Chi-aquare test
Journal_ab2_general_tab <- table(Journal_abstract_report_general$Abstract2)
...
```{r}
cor.test(Region_psy_cordata$psy2021, Region_psy_cordata$Journal, method = "spearman", exact = F)
```

the second applied psychology of Shanghai Ranking
```{r}
cor.test(Region_appliedpsy_cordata$Appliedpsy2021, Region_appliedpsy_cordata$Journal, method = "spearman", exact = F)
```
