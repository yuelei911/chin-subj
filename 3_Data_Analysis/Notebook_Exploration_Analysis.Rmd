...
spearman relation
Spearman’s correlation was calculated following the method of van Doorn et al. (2020), https://doi.org/10.1080/02664763.2019.1709053

van Doorn et al. (2020)' R code
```{r}
# Spearman's rho function, R file from van Doorn et al. (2020)
...
the first psychology of Shanghai Ranking
```{r}
set.seed(202301301)
# Default beta prior width is set to a = b = 1 for the sampler 
psy1 <- spearmanGibbsSampler(xVals = Region_psy_cordata$psy2021,
                                   yVals = Region_psy_cordata$Journal, 
                                   nSamples = 5e3)

# Give the posterior samples for rho to the function below to compute BF01
BF_psy <- computeBayesFactorOneZero(psy1$rhoSamples, 
                          whichTest = "Spearman",
                          priorParameter = 1)
...
the second applied psychology of Shanghai Ranking
```{r}
set.seed(202301302)
appliedpsy1 <- spearmanGibbsSampler(xVals = Region_appliedpsy_cordata$Appliedpsy2021,
                                   yVals = Region_appliedpsy_cordata$Journal, 
                                   nSamples = 5e3)

# Give the posterior samples for rho to the function below to compute BF01
BF_appliedpsy <- computeBayesFactorOneZero(appliedpsy1$rhoSamples, 
                          whichTest = "Spearman",
                          priorParameter = 1)
