...
ggsave(here("3_Data_Analysis","3_2_image","Journal_report_year.png"), 
       Journal_report_year, device = "png", width=12, height = 9, dpi = 600)
...
ggsave(here("3_Data_Analysis","3_2_image","Journal_report_target_population.png"), Journal_report_target_population, device = "png", width=12, height = 9, dpi = 600)
...
ggsave(here("3_Data_Analysis","3_2_image","Suppl_Fig_Special_Wordcloud_Barplot.png"),
       Suppl_Fig_Special_Wordcloud_Barplot, device = "png", width=18, height = 9, dpi = 600)
```
...
ggsave(here("3_Data_Analysis","3_2_image","Suppl_Fig_H2_gender_general.png"),
       Suppl_Fig_H2_gender_general, device = "png", width=18, height = 9, dpi = 600)
...
SupplH2_BF_gender_BTS_CFPS <- BayesMultiNomial(dataset = SupplH2_gender_general_bayes,
                                             ...
                                             expected = "CFPS2018")
```
Journal vs Census6: $Log(BF_{a0})$ = `r SupplH2_BF_gender_Journal_Census6$BF$LogBFa0`.

BTS vs Census6: $Log(BF_{a0})$ = `r SupplH2_BF_gender_BTS_Census6$BF$LogBFa0`.

Journal vs Census7: $Log(BF_{a0})$ = `r SupplH2_BF_gender_Journal_Census7$BF$LogBFa0`.

BTS vs Census7: $Log(BF_{a0})$ = `r SupplH2_BF_gender_BTS_Census7$BF$LogBFa0`.

Journal vs CFPS2018: $Log(BF_{a0})$ = `r SupplH2_BF_gender_Journal_CFPS$BF$LogBFa0`.

BTS vs CFPS2018: $Log(BF_{a0})$ = `r SupplH2_BF_gender_BTS_CFPS$BF$LogBFa0`.
...
SupplH2_Census7_age_general <- ggplot(data= Census7_age_five5,
  ...
  theme(panel.border =element_rect(fill=NA,color="black"),
        ...
        axis.title = element_text(size = 16,family = "serif"),
        axis.text = element_text(size = 16,family = "serif"))+
  scale_fill_manual(values = c("Census7" = "#56B4E9")) +
...
ggsave(here("3_Data_Analysis","3_2_image","SupplH2_Census7_age_general.png"),
       SupplH2_Census7_age_general, device = "png", width=18, height = 9, dpi = 600)
...
SupplH2_Census6_age_general <- ggplot(data= Census6_age_five5,
  ...
  theme(panel.border =element_rect(fill=NA,color="black"),
        ...
        axis.title = element_text(size = 16,family = "serif"),
        axis.text = element_text(size = 16,family = "serif"))+
  scale_fill_manual(values = c("Census6" = "#56B4E9")) +
  scale_color_manual(values = c("BTS Chinese"= "blue", "Journal" = "#E69F00"))
...
ggsave(here("3_Data_Analysis","3_2_image","SupplH2_Census6_age_general.png"),
       SupplH2_Census6_age_general, device = "png", width=18, height = 9, dpi = 600)
...
SupplH2_BF_interval10_Journal_Census6 <- BayesMultiNomial(dataset =Suppl_interval10_bayes,
                                             ...
                                             expected = "Census6")
```
BTS vs Census6 in PsyStages: $Log(BF_{a0})$ = `r SupplH2_BF_Psystages_BTS_Census6$BF$LogBFa0`.

BTS vs Census6 in interval10: $Log(BF_{a0})$ = `r SupplH2_BF_interval10_BTS_Census6$BF$LogBFa0`.

Journal vs Census6 in Psystages: $Log(BF_{a0})$ = `r SupplH2_BF_Psystages_Journal_Census6$BF$LogBFa0`.

Journal vs Census6 in interval10: $Log(BF_{a0})$ = `r SupplH2_BF_interval10_Journal_Census6$BF$LogBFa0`.
...
SupplH2_BF_interval10_Journal_Census7 <- BayesMultiNomial(dataset =Suppl_interval10_bayes,
                                             ...
                                             expected = "Census7")
```
BTS vs Census7 in PsyStages: $Log(BF_{a0})$ = `r SupplH2_BF_Psystages_BTS_Census7$BF$LogBFa0`.

BTS vs Census7 in interval10: $Log(BF_{a0})$ = `r SupplH2_BF_interval10_BTS_Census7$BF$LogBFa0`.

Journal vs Census7 in Psystages: $Log(BF_{a0})$ = `r SupplH2_BF_Psystages_Journal_Census7$BF$LogBFa0`.

Journal vs Census7 in interval10: $Log(BF_{a0})$ = `r SupplH2_BF_interval10_Journal_Census7$BF$LogBFa0`.
...
Suppl_BF_highschool_Journal_Census6 <-  BayesMultiNomial(dataset = Suppl_highschool,
                                             ...
                                             expected = "Census6")
```
BTS vs Census6 in college: $Log(BF_{a0})$ = `r Suppl_BF_college_BTS_Census6$BF$LogBFa0`.

Journal vs Census6 in college: $Log(BF_{a0})$ = `r Suppl_BF_college_Journal_Census6$BF$LogBFa0`.

BTS vs Census6 in high school: $Log(BF_{a0})$ = `r Suppl_BF_highschool_BTS_Census6$BF$LogBFa0`.

Journal vs Census6 in high school: $Log(BF_{a0})$ = `r Suppl_BF_highschool_Journal_Census6$BF$LogBFa0`.
...
Suppl_BF_highschool_Journal_Census7 <-  BayesMultiNomial(dataset = Suppl_highschool,
                                             ...
                                             expected = "Census7")
```
BTS vs Census7 in college: $Log(BF_{a0})$ = `r Suppl_BF_college_BTS_Census7$BF$LogBFa0`.

Journal vs Census7 in college: $Log(BF_{a0})$ = `r Suppl_BF_college_Journal_Census7$BF$LogBFa0`.

BTS vs Census7 in high school: $Log(BF_{a0})$ = `r Suppl_BF_highschool_BTS_Census7$BF$LogBFa0`.

Journal vs Census7 in high school: $Log(BF_{a0})$ = `r Suppl_BF_highschool_Journal_Census7$BF$LogBFa0`.
...
SupplH2_BF_Journal_CFPS2018_region_four <- BayesMultiNomial(dataset = SupplH2_region_four_bayes,
                                          ...
                                          expected = "CFPS2018")
```
Journal vs Census6 in all studies:$Log(BF_{a0})$ = `r SupplH2_BF_Journal_Census6_region_four$BF$LogBFa0`.

Journal vs Census7 in all studies:$Log(BF_{a0})$ = `r SupplH2_BF_Journal_Census7_region_four$BF$LogBFa0`.

Journal vs CFPS2018 in all studies:$Log(BF_{a0})$ = `r SupplH2_BF_Journal_CFPS2018_region_four$BF$LogBFa0`.
...
SupplH2_BF_Journal_CFPS2018_region_seven <- BayesMultiNomial(dataset = SupplH2_region_seven_bayes,
                                          ...
                                          expected = "CFPS2018")
```
Journal vs Census6 in all studies:$Log(BF_{a0})$ = `r SupplH2_BF_Journal_Census6_region_seven$BF$LogBFa0`.

Journal vs Census7 in all studies:$Log(BF_{a0})$ = `r SupplH2_BF_Journal_Census7_region_seven$BF$LogBFa0`.

Journal vs CFPS2018 in all studies:$Log(BF_{a0})$ = `r SupplH2_BF_Journal_CFPS2018_region_seven$BF$LogBFa0`.
...
SupplH2_BF_experi_CFPS2018_region_four <- BayesMultiNomial(dataset = SupplH2_region_four_experi_bayes,
                                          ...
                                          expected = "CFPS2018")
```
Journal vs Census6 in experi:$Log(BF_{a0})$ = `r SupplH2_BF_experi_Census6_region_four$BF$LogBFa0`.

Journal vs Census7 in experi:$Log(BF_{a0})$ = `r SupplH2_BF_experi_Census7_region_four$BF$LogBFa0`.

Journal vs CFPS2018 in experi:$Log(BF_{a0})$ = `r SupplH2_BF_experi_CFPS2018_region_four$BF$LogBFa0`.
...
SupplH2_BF_experi_CFPS2018_region_seven <- BayesMultiNomial(dataset = SupplH2_region_seven_experi_bayes,
                                          ...
                                          expected = "CFPS2018")
```
Journal vs Census6 in experi:$Log(BF_{a0})$ = `r SupplH2_BF_experi_Census6_region_seven$BF$LogBFa0`.

Journal vs Census7 in experi:$Log(BF_{a0})$ = `r SupplH2_BF_experi_Census7_region_seven$BF$LogBFa0`.

Journal vs CFPS2018 in experi:$Log(BF_{a0})$ = `r SupplH2_BF_experi_CFPS2018_region_seven$BF$LogBFa0`.
...
SupplH2_BF_questionaire_CFPS2018_region_four <- BayesMultiNomial(dataset = SupplH2_region_four_questionaire_bayes,
                                          ...
                                          expected = "CFPS2018")
```
Journal vs Census6 in questionaire:$Log(BF_{a0})$ = `r SupplH2_BF_questionaire_Census6_region_four$BF$LogBFa0`.

Journal vs Census7 in questionaire:$Log(BF_{a0})$ = `r SupplH2_BF_questionaire_Census7_region_four$BF$LogBFa0`.

Journal vs CFPS2018 in questionaire:$Log(BF_{a0})$ = `r SupplH2_BF_questionaire_CFPS2018_region_four$BF$LogBFa0`.
...
SupplH2_BF_questionaire_CFPS2018_region_seven <- BayesMultiNomial(dataset = SupplH2_region_seven_questionaire_bayes,
                                          ...
                                          expected = "CFPS2018")
```
Journal vs Census6 in questionaire:$Log(BF_{a0})$ = `r SupplH2_BF_questionaire_Census6_region_seven$BF$LogBFa0`.

Journal vs Census7 in questionaire:$Log(BF_{a0})$ = `r SupplH2_BF_questionaire_Census7_region_seven$BF$LogBFa0`.

Journal vs CFPS2018 in questionaire:$Log(BF_{a0})$ = `r SupplH2_BF_questionaire_CFPS2018_region_seven$BF$LogBFa0`.
...
ggsave(here("3_Data_Analysis","3_2_image","SupplH2_Fig_region_studytype.png"), SupplH2_Fig_region_studytype, device = "png", width=10, height = 6, dpi = 600)
...
ggsave(here("3_Data_Analysis","3_2_image","Suppl_Fig_Wordcloud.png")
,Suppl_Fig_Wordcloud, device = "png", width=18, height = 9)
```
...
SupplH3_Fig_age_four <- ggplot(H3_age_four2, aes(x=Proportion, y=ISO3, fill=ageBins)) +
  ...
  scale_fill_discrete(label=c("<=17", "18~40", "41~60",">=61")) +
  theme_classic()+
...
ggsave(here("3_Data_Analysis","3_2_image","SupplH3_Fig_age_four.png"),
       SupplH3_Fig_age_four,device = "png", width=18, height = 18, dpi = 600)
```
