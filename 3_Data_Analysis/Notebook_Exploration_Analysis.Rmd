...
```{r}
load("Journal_special_target_population2.RData")
...
Journal_special_visual2 <- readxl::read_xlsx("Journal_special_visual_complete_translation.xlsx") %>% 
  dplyr::mutate(cate = ifelse(Count == 1,"one",Count))

Special_Wordcloud <- Journal_special_visual2 %>% 
...
Journal_special_visual_bar <-  Journal_special_visual_gt3 %>% 
...
Journal_special_visual_bar

Special_Wordcloud_Barplot <- Special_Wordcloud + Journal_special_visual_bar

ggsave("Special_Wordcloud_Barplot.pdf",Special_Wordcloud_Barplot, device = "pdf", width=18, height = 9)
...
```{r}
load("ShanghaiRanking_psy.Rdata")
...
Wordcloud <- Fig_BTS_wordcloud + Journal_wordcloud

Wordcloud

ggsave("Wordcloud.pdf",Wordcloud, device = "pdf", width=18, height = 9)
```
