...
table(Journal_education_occupation_report$Educational_Attainment_N) ## FALSE 165 TRUE 141
...
Journal_education_occupation_table <- data.frame(Var1 = c("Unreported","Reported",
                                                   ...
                                                   proportion = c(165/(165+141),141/(165+141),201/(201+105),105/(201+105)))
...
Journal_age_fuzzy_report_study_num <- Journal_age_fuzzy_report %>% 
  dplyr::distinct(Article_IDs,Study_Number)  ## 142-6=136
