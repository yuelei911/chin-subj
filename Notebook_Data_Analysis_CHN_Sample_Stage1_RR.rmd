...
Now, because Jones et al.(201)' data is needed for the next part (Re-addressing the age bin issue), let's load and preprocess the data first.
...
# We also used the bootstrap method to get the mean of SD and the distribution of SD
