...
(Lines 191 to 462 of the code, that's our simulations, this part of the code takes a long time to run. Therefore, it is not shown their running results in our html file(Notebook_Data_Analysis_CHN_Sample_Stage1_RR.html), see Rmarkdown for details(Notebook_Data_Analysis_CHN_Sample_Stage1_RR.RMD)
