...
(Lines 191 to 645 of the code and line 691 to 784, that's our simulations, this part of the code takes a long time to run. Therefore, it is not shown their running results in our html file(Notebook_Data_Analysis_CHN_Sample_Stage1_RR.html), see Rmarkdown for details(Notebook_Data_Analysis_CHN_Sample_Stage1_RR.RMD)
...
for (kk in (seq(length(sim_age_diff)))){
  tmp_BF <- Sim_Sens_mult(Mean1=df_PSA001_CN_M, 
...
########### traditional for loop, all commented but the code was remained below ################
# pacman::p_load("truncnorm")
...
########### End of the traditional for loop #################################################

########### using foreach for faster simulation #################################################
