...
Sim_Power_mult_calc <- function(seed = 12345, 
                           sim_N = 100,             # set to 5000 for real simulation
...
Sim_Power_mult <- function(seed = 12345,
                           sim_N_probs = 10,        # set to 10000 for real simulation
                           alpha_sim = 1){
  set.seed(seed)
...
rm('Res_Sim')
for (alpha_sim in c(1:5, 10)){
  # print(alph_sim)
  Sim_res_tmp <-  Sim_Power_mult(alpha_sim = alpha_sim)
