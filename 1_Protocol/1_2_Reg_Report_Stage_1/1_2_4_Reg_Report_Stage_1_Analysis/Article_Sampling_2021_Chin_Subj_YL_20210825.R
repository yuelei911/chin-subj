...
journal1<-read.table("Acta Psychologica Sinica 2021.txt")  #Acta Psychologica Sinica
journal1<-t(journal1)
journal2<-read.table("Journal of Psychological Science 2021.txt")  #Journal of Psychological Science
journal2<-t(journal2)
journal3<-read.table("Chinese Journal of Clinical Psychology 2021.txt")  #Chinese Journal of Clinical Psychology
journal3<-t(journal3)
journal4<-read.table("Psychological Development and Education 2021.txt")  #Psychological Development and Education
journal4<-t(journal4)
journal5<-read.table("Studies of Psychology and Behavior 2021.txt")  #Studies of Psychology and Behavior
journal5<-t(journal5)

#The number of articles drawn from each magazine
num<-c(28,61,94,29,38)
#set random seeds
set.seed(1000)
...
write.table(chioce,"sample 2021.txt",row.names=F,col.names=F)
