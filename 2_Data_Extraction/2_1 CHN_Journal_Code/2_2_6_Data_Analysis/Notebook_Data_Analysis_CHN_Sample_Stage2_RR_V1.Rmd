...
### Article_IDs 20081110
df_stage2_Journal_Code2$Sample_Type_N[22] <- 4

### Article_IDs 20083052
df_stage2_Journal_Code2$Sample_Type_N[43:44] <- 4

### Article_IDs 20083072
df_stage2_Journal_Code2$Sample_Type_N[53] <- 4

### Article_IDs 20083093
df_stage2_Journal_Code2$Sample_Type_N[63:64] <- 4

### Article_IDs 20083099
df_stage2_Journal_Code2$Sample_Type_N[65] <- 4

### Article_IDs 20181143
df_stage2_Journal_Code2$Sample_Type_N[83:84] <- 4

### Article_IDs 20183321
df_stage2_Journal_Code2$Sample_Type_N[166:169] <- 4

### Article_IDs 20082061
df_stage2_Journal_Code2$Sample_Type_N[249] <- 4

### Article_IDs 20082107
df_stage2_Journal_Code2$Sample_Type_N[269] <- 4

### Article_IDs 20083218
df_stage2_Journal_Code2$Sample_Type_N[289] <- 4

### Article_IDs 20182017
df_stage2_Journal_Code2$Sample_Type_N[330] <- 4
df_stage2_Journal_Code2$Sample_Type_N[334] <- 4

###Article_IDs 20183071
df_stage2_Journal_Code2$Sample_Type_N[369:370] <- 4

### Article_IDs 20183098
df_stage2_Journal_Code2$Sample_Type_N[379:381] <- 4

### Article_IDs 20183099
df_stage2_Journal_Code2$Sample_Type_N[383] <- 4

### Article_IDs 20211033
df_stage2_Journal_Code2$Sample_Type_N[415:421] <- 4

### Article_IDs 20211040
df_stage2_Journal_Code2$Sample_Type_N[424:426] <- 4
df_stage2_Journal_Code2$Sample_Type_N[428] <- 4

### Article_IDs 20211061
df_stage2_Journal_Code2$Sample_Type_N[437] <- 4
df_stage2_Journal_Code2$Sample_Type_N[439] <- 4

### Article_IDs 20211063
df_stage2_Journal_Code2$Sample_Type_N[441:446] <- 4

### Article_IDs 20211064
df_stage2_Journal_Code2$Sample_Type_N[447:449] <- 4
df_stage2_Journal_Code2$Sample_Type_N[451:452] <- 4
...
### Article_IDs 20211078
df_stage2_Journal_Code2$Sample_Type_N[457:458] <- 4

### Article_IDs 20211089
df_stage2_Journal_Code2$Sample_Type_N[460:461] <- 4

### Article_IDs 20213199
df_stage2_Journal_Code2$Sample_Type_N[470] <- 4
...
### Article_IDs 20182036
df_stage2_Journal_Code2$Sample_Type_N[556:557] <- 4

### Article_IDs 20182052
df_stage2_Journal_Code2$Sample_Type_N[568:569] <- 4

### Article_IDs 20183107
df_stage2_Journal_Code2$Sample_Type_N[590] <- 4

### Article_IDs 20183129
df_stage2_Journal_Code2$Sample_Type_N[598] <- 4

### Article_IDs 20183131
df_stage2_Journal_Code2$Sample_Type_N[599:600] <- 4

### Article_IDs 20212031
df_stage2_Journal_Code2$Sample_Type_N[649] <- 4

### Article_IDs 20212056
df_stage2_Journal_Code2$Sample_Type_N[658] <- 4

### Article_IDs 20212062
df_stage2_Journal_Code2$Sample_Type_N[661:664] <- 4

### Article_IDs 20212067
df_stage2_Journal_Code2$Sample_Type_N[666] <- 4

### Article_IDs 20214016
df_stage2_Journal_Code2$Sample_Type_N[689:691] <- 4

### Article_IDs 20182148
df_stage2_Journal_Code2$Sample_Type_N[841]  <- 4

### Article_IDs 20212122
df_stage2_Journal_Code2$Sample_Type_N[942] <- 1

###Article_IDs 20181030
df_stage2_Journal_Code2$Sample_Type_N[1019:1020] <- 4

### Article_IDs 20181069
df_stage2_Journal_Code2$Sample_Type_N[1046] <- 4

### Article_IDs 20182163
df_stage2_Journal_Code2$Sample_Type_N[1059] <- 4

### Article_IDs 20183221
df_stage2_Journal_Code2$Sample_Type_N[1102] <- 4

### Article_IDs 20183229
df_stage2_Journal_Code2$Sample_Type_N[1109:1110] <- 4

### Article_IDs 20185038
df_stage2_Journal_Code2$Sample_Type_N[1124:1126] <- 4
...
df_stage2_Journal_Code2$Sample_Type_N[1165:1166] <- 4

### Article_IDs 20212165
df_stage2_Journal_Code2$Sample_Type_N[1170:1173] <- 4

### Article_IDs 20212173
df_stage2_Journal_Code2$Sample_Type_N[1180:1181] <- 4

### Article_IDs 20083109
df_stage2_Journal_Code2$Sample_Type_N[1495] <- 4

### Article_IDs 20083110
df_stage2_Journal_Code2$Sample_Type_N[1496] <- 4

### Article_IDs 20083170
df_stage2_Journal_Code2$Sample_Type_N[1513] <- 4

### Article_IDs 20083173
df_stage2_Journal_Code2$Sample_Type_N[1514] <- 4
...
df_stage2_Journal_Code2$Sample_Type_N[1552:1554] <- 4

### Article_IDs 20183013
df_stage2_Journal_Code2$Sample_Type_N[1558] <- 4

### Article_IDs 20211025
df_stage2_Journal_Code2$Sample_Type_N[1631:1632] <- 4
...
df_stage2_Journal_Code2 <- df_stage2_Journal_Code2 %>% 
  dplyr::mutate(Sample_Type_N = as.numeric(Sample_Type_N)) %>% 
  dplyr::mutate(Educational_Attainment_N = ifelse(Sample_Type_N > 10, NA, Educational_Attainment_N),
                Educational_Attainment_info_N =ifelse(Sample_Type_N > 10 ,NA, Educational_Attainment_info_N),
                Occupation_N = ifelse(Sample_Type_N > 10 , NA, Occupation_N))
```
...
Educational_Attainment_recode_ocuupation <- Educational_Attainment_recode %>% 
...
rm(Educational_Attainment_recode,Educational_Attainment_recode_ocuupation)
