...
## both < 1
Journal_compulsory_edu_decimal<- Journal_edu2_compulsory_edu  %>%
  dplyr::filter(Compulsory_edu_above <= 1 & Compulsory_edu <= 1) %>% 
...
## edu year
H2_Fig_edu_year <- ggplot(data = Journal_edu2_year,aes(Article_IDs,M_edu_year,size = Sample_Size))+
  geom_point(color = "#00BFC4")+
  ylab("The number of years of education")+
  coord_flip()+
  theme_classic()+
  theme(legend.position = "none",    
        axis.title= element_text(size = 15,family = "serif"),
