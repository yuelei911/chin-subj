...
writexl::write_xlsx(BTS_Overview2,"BTS_samples.xlsx")
...
Sim_Journal_age_PsyStages3_general <- Sim_Journal_age_PsyStages2_general %>% 
  ...
  dplyr::ungroup() %>% 
  dplyr::mutate(ageBins =factor(ageBins,
                                levels = c("<=17","18~40", "41~60", "41~60", ">=61")))
...
## The prop of 18~25 more than China (61.08) 这里需要改
...
I save multi data for bayes analysis based on chi-square.
```{r}
save(H1_gender_general,Lucca_gender_special,Journal_gender_special,
     Sim_Journal_age_PsyStages3_general,BTS_age_PsyStages_CHN_general,
     Sim_Journal_age_interval103_general,BTS_age_interval10_CHN_general,
     H1_edu_college,H1_edu_highschool,
     H2_gender_general,H2_gender_preschool_special_prop,Census7_gender_preschool_special,
     Journal_gender_college_sepcial2,
     Census7_age_PsyStages,Census7_age_interval10,
     H2_edu_college,H2_edu_highschool,
     Journal_region_four,Journal_region_seven,H2_region_four_bayes,H2_region_seven_bayes,
     H3_gender,H3_PsyStages2,H3_interval10,
    file = "Chi_Square_bayes.RData")
```
