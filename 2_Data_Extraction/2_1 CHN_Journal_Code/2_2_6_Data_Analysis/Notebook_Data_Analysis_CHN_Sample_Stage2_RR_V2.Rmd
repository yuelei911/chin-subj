...
sum(Target_population_general_gender$Male_Proportion)+sum(Target_population_general_gender$Female_Proportion)
...
sum(Target_population_special_gender$Male_Proportion)+sum(Target_population_special_gender$Female_Proportion)
...
Journal_gender_college_sepcial2 <- Journal_gender_college_sepcial %>% 
  ...
  tidyr::pivot_longer(cols = c("Male","Female"),
                      names_to = "Gender",
                      values_to = "n") %>% 
  dplyr::mutate(Proportion = n/sum(n)*100) ## Male 44.95 / Female 55.05
