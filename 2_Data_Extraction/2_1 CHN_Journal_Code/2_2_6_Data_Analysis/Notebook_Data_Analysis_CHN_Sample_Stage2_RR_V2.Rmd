...
```{r}
Journal_BTS_CHN_gender <- ggplot(data = Journal_BTS_CHN_gender,aes(Data_Source,Proportion,fill = Gender))+
  geom_col()+
...
ggsave("Journal_BTS_CHN_gender.pdf", Journal_BTS_CHN_gender, device = "pdf", width=18, height = 9)

Journal_BTS_CHN_gender
...
for(i in seq_along(BTS_data)){
  ...
  if("Age" %in% names(BTS_data[[i]])){
    ...
    BTS_age <- BTS_data[[i]] %>% 
      ...
      dplyr::mutate(ageBins = cut(Age,
                                breaks = c(-Inf, 17.5, 25.5, 40.5, 59.5, Inf),
  ...
  Age_bins <- c("0~17","18~25","26~40","41~59",">=60")
...
```{r}
### Arechar_et_al_2023
Arechar_et_al_2023_CHN_age <- ggplot(data= df_census7_Age, 
       aes(x=ageBins, y = Proportion, fill="Census 7")) +
  geom_col(alpha=0.5, width = 1) +
...
Arechar_et_al_2023_CHN_age


### Azevedo_et_al_2022_mainland
Azevedo_et_al_2022_mainland_CHN_age <- ggplot(data= df_census7_Age, 
       aes(x=ageBins, y = Proportion, fill="Census 7")) +
  geom_col(alpha=0.5, width = 1) +
...
Azevedo_et_al_2022_mainland_CHN_age


## Azevedo_et_al_2022_taiwan
Azevedo_et_al_2022_taiwan_CHN_age <- ggplot(data= df_census7_Age, 
       aes(x=ageBins, y = Proportion, fill="Census 7")) +
  geom_col(alpha=0.5, width = 1) +
...
Azevedo_et_al_2022_taiwan_CHN_age


## Combined graph
Journal_BTS_CHN_age <-  Journal_age + Arechar_et_al_2023_CHN_age + 
  Azevedo_et_al_2022_mainland_CHN_age + Azevedo_et_al_2022_taiwan_CHN_age +
