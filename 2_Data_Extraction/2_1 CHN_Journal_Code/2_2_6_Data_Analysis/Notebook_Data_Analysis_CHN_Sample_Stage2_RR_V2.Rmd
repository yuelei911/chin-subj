...
First, I create func to process age data simulation
```{r}
Sim_Sens_mult <- function(Mean1, diff_age, SD1, SD2, sampe_N=Sample_Size){
...
#### Bayesian multinomial test for region from journal, census 7 and CFPS
```{r}
...
BF_H3_interval10_Journal_BTS$CHN[7] <- 0.001
