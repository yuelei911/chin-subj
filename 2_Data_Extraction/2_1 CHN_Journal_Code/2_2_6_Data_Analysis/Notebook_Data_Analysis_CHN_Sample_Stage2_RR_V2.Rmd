...
BTS_age_CHN_3rows <- data.frame(ageBins = c("0~4","5~9","10~14"),
                                n = 0,
                                Proportion = 0,
                                Data_Source = "BTS Chinese")
...
H1_age <- Sim_Journal_age_five3_prop %>% 
  dplyr::rename(n = 2) %>% 
  dplyr::bind_rows(BTS_age_CHN,BTS_age_CHN_3rows)
...
When we divide the age into 10 years,we found strong evidence for the $H_1$ that the age distribution from BTS data is different from that of Chinese journal data, with $Log(BF_{10})$ = `r H1_BF_interval10$BF$LogBF10`.

When we divide age into stages of psychological development, we found strong evidence for the $H_1$ that the age distribution from BTS data is different from that of Chinese journal data, with $Log(BF_{10})$ = `r H1_BF_PsyStages$BF$LogBF10`.
