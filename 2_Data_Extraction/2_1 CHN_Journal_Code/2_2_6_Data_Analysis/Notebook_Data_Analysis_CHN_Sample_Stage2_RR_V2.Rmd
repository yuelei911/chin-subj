...
rm(Journal_age_report_detail,Journal_age_report_detail_study_num,
   Journal_age_fuzzy_report,Journal_age_fuzzy_report_study_num, Journal_age_report_detail_study_num)
```
...
H2_BF_Journal_general_CFPS2018_region <- BayesMultiNomial(dataset = H2_region_bayes,
                                          factor = "Region",
                                          observed = "Journal_region_general_population",
                                          expected = "CFPS2018")
```
