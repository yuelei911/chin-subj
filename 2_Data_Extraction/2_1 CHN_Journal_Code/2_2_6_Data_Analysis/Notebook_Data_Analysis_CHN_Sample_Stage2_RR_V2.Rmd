...
Target_population_general_age <-  Journal_age2 %>%
  dplyr::filter(Target_Population_N != 1)

## simulate different categories age data
### five-year-old
Sim_Journal_general_age_five1 <- lapply(1:nrow(Target_population_general_age),function(i){
  
  Sim_Sens_mult_five(Mean0 = Target_population_general_age$M_age[i],
                diff_age = 0,
                SD0 = Target_population_general_age$SD_age[i],
                sample_N = Target_population_general_age$Sample_Size[i])
  
  })


Sim_Journal_general_age_five2 <- do.call(rbind,Sim_Journal_general_age_five1)


Sim_Journal_general_age_five3 <- Sim_Journal_general_age_five2 %>% 
  dplyr::group_by(ageBins) %>% 
  dplyr::summarise(sim1 = round(sum(sim1,na.rm = TRUE))) %>% 
  dplyr::ungroup() %>% 
  dplyr::mutate(ageBins =factor(ageBins,
...
## Calculate the sample difference between the coded data and the simulated data
sum(Target_population_general_age$Sample_Size)-sum(Sim_Journal_general_age_five3$sim1,na.rm = TRUE) 


## PsyStages
Sim_Journal_general_age_PsyStages1 <- lapply(1:nrow(Target_population_general_age),function(i){
  
  Sim_Sens_mult_PsyStages(Mean1 = Target_population_general_age$M_age[i],
                diff_age = 0,
                SD1 = Target_population_general_age$SD_age[i],
                sample_N = Target_population_general_age$Sample_Size[i])
  
  })


Sim_Journal_general_age_PsyStages2 <- do.call(rbind,Sim_Journal_general_age_PsyStages1)


Sim_Journal_general_age_PsyStages3 <- Sim_Journal_general_age_PsyStages2 %>% 
  dplyr::group_by(ageBins) %>% 
  dplyr::summarise(sim1 = round(sum(sim1,na.rm = TRUE))) %>% 
  dplyr::ungroup() %>% 
  dplyr::mutate(ageBins =factor(ageBins,
...
## Calculate the sample difference between the coded data and the simulated data
sum(Target_population_general_age$Sample_Size)-sum(Sim_Journal_general_age_PsyStages3$sim1,na.rm = TRUE)


## ten-years-old
Sim_Journal_general_age_interval101 <- lapply(1:nrow(Target_population_general_age),function(i){
  
  Sim_Sens_mult_interval10(Mean2 = Target_population_general_age$M_age[i],
                diff_age2 = 0,
                SD2 = Target_population_general_age$SD_age[i],
                sample_N2 = Target_population_general_age$Sample_Size[i])
  
  })


Sim_Journal_general_age_interval102 <- do.call(rbind,Sim_Journal_general_age_interval101)


## Use simulation function to process data. 
Sim_Journal_general_age_interval103 <- Sim_Journal_general_age_interval102 %>% 
  dplyr::group_by(ageBins) %>% 
  dplyr::summarise(sim1 = round(sum(sim1,na.rm = TRUE))) %>% 
  dplyr::ungroup() %>% 
  dplyr::mutate(ageBins =factor(ageBins,
...
## Calculate the sample difference between the coded data and the simulated data
sum(Target_population_general_age$Sample_Size)-sum(Sim_Journal_general_age_interval103$sim1,na.rm = TRUE)
```


The others is special target population
```{r}
Target_population_special_age <- Journal_age2 %>% 
  dplyr::filter(Target_Population_N == 1)


## simulate different categories age data
### five-year-old
Sim_Journal_special_age_five1 <- lapply(1:nrow(Target_population_special_age),function(i){
  
  Sim_Sens_mult_five(Mean0 = Target_population_special_age$M_age[i],
                diff_age = 0,
                SD0 = Target_population_special_age$SD_age[i],
                sample_N = Target_population_special_age$Sample_Size[i])
  
  })


Sim_Journal_special_age_five2 <- do.call(rbind,Sim_Journal_special_age_five1)


Sim_Journal_special_age_five3 <- Sim_Journal_special_age_five2 %>% 
  dplyr::group_by(ageBins) %>% 
  dplyr::summarise(sim1 = round(sum(sim1,na.rm = TRUE))) %>% 
  dplyr::ungroup() %>% 
  dplyr::mutate(ageBins =factor(ageBins,
...
## Calculate the sample difference between the coded data and the simulated data
sum(Target_population_special_age$Sample_Size)-sum(Sim_Journal_special_age_five3$sim1,na.rm = TRUE) 


## PsyStages
Sim_Journal_special_age_PsyStages1 <- lapply(1:nrow(Target_population_special_age),function(i){
  
  Sim_Sens_mult_PsyStages(Mean1 = Target_population_special_age$M_age[i],
                diff_age = 0,
                SD1 = Target_population_special_age$SD_age[i],
                sample_N = Target_population_special_age$Sample_Size[i])
  
  })


Sim_Journal_special_age_PsyStages2 <- do.call(rbind,Sim_Journal_special_age_PsyStages1)


Sim_Journal_special_age_PsyStages3 <- Sim_Journal_special_age_PsyStages2 %>% 
  dplyr::group_by(ageBins) %>% 
  dplyr::summarise(sim1 = round(sum(sim1,na.rm = TRUE))) %>% 
  dplyr::ungroup() %>% 
  dplyr::mutate(ageBins =factor(ageBins,
...
## Calculate the sample difference between the coded data and the simulated data
sum(Target_population_special_age$Sample_Size)-sum(Sim_Journal_special_age_PsyStages3$sim1,na.rm = TRUE)


## ten-years-old
Sim_Journal_special_age_interval101 <- lapply(1:nrow(Target_population_special_age),function(i){
  
  Sim_Sens_mult_interval10(Mean2 = Target_population_special_age$M_age[i],
                diff_age2 = 0,
                SD2 = Target_population_special_age$SD_age[i],
                sample_N2 = Target_population_special_age$Sample_Size[i])
  
  })


Sim_Journal_special_age_interval102 <- do.call(rbind,Sim_Journal_special_age_interval101)


## Use simulation function to process data. 
Sim_Journal_special_age_interval103 <- Sim_Journal_special_age_interval102 %>% 
  dplyr::group_by(ageBins) %>% 
  dplyr::summarise(sim1 = round(sum(sim1,na.rm = TRUE))) %>% 
  dplyr::ungroup() %>% 
  dplyr::mutate(ageBins =factor(ageBins,
...
## Calculate the sample difference between the coded data and the simulated data
sum(Target_population_special_age$Sample_Size)-sum(Sim_Journal_special_age_interval103$sim1,na.rm = TRUE)
```
