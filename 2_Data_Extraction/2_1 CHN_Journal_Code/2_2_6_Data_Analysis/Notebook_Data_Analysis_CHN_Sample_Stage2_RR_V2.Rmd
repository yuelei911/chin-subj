...
## Load the data of stage 1 and Chinese journal coding data
```{r}
...
## The basic situation of Chinese journal coding data
```{r}
...
## CHN Journa and BTS' CHN gender




### Batch process BTS' gender
```{r message=FALSE, warning=FALSE}
