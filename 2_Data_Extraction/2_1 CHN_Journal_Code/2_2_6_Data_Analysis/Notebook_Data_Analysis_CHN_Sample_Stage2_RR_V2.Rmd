...
### Gender
In this part, I processed gender data of the Census 7th data and the CFPS2018 data.
```{r}
...
```{r}
save(H1_gender_general,H2_gender_general,file = "H2_gender_exploration.Rdata") ## data include papers, projects, and Census data.
```
...
Census7_age_PsyStages <- Census7_age %>% 
  dplyr::mutate(ageBins = cut(ageBins,
                                ...
                                labels = c("<=17","18~25","26~40", "41~60", ">=61"),
                                levels = c("<=17","18~25","26~40", "41~60", ">=61"))) %>% 
  dplyr::mutate(n  = ifelse(ageBins == ">61", n+118866,n)) %>% ## include 100 years old and above
