...
df_Arechar_et_al_2023_age <- df_Arechar_et_al_2023 %>% 
  ...
  dplyr::count(ageBins) %>% 
  dplyr::mutate(Proportion = round((n/sum(n))*100,2)) %>% 
  dplyr::mutate(Data_Source = "Arechar_et_al_2023",n=as.numeric(n))

df_Arechar_et_al_2023_age <- df_Arechar_et_al_2023_age %>% 
  dplyr::full_join(Age_bins, by = "ageBins") %>% 
  dplyr::rename(n = 2, Proportion = 3, Data_Source = 4) %>% 
  dplyr::select(1:4) %>% 
  dplyr::mutate(n = ifelse(is.na(n),0,n),
                Proportion = ifelse(is.na(Proportion),0,Proportion),
                Data_Source = ifelse(is.na(Data_Source),"Arechar_et_al_2023",Data_Source))
...
df_Azevedo_et_al_2022_mainland_age <- df_Azevedo_et_al_2022_mainland %>% 
  ...
  dplyr::count(ageBins) %>% 
  dplyr::mutate(Proportion = round((n/sum(n))*100,2)) %>% 
  dplyr::mutate(Data_Source = "Azevedo_et_al_2022_mainland",n=as.numeric(n))


df_Azevedo_et_al_2022_mainland_age <- df_Azevedo_et_al_2022_mainland_age %>% 
  dplyr::full_join(Age_bins, by = "ageBins") %>% 
  dplyr::rename(n = 2, Proportion = 3, Data_Source = 4) %>% 
  dplyr::select(1:4) %>% 
  dplyr::mutate(n = ifelse(is.na(n),0,n),
                Proportion = ifelse(is.na(Proportion),0,Proportion),
                Data_Source = ifelse(is.na(Data_Source),"Azevedo_et_al_2022_mainland",Data_Source))
...
df_Azevedo_et_al_2022_taiwan_age <- df_Azevedo_et_al_2022_taiwan %>%
  ...
  dplyr::count(ageBins) %>% 
  dplyr::mutate(Proportion = round((n/sum(n))*100,2)) %>% 
  dplyr::mutate(Data_Source = "Azevedo_et_al_2022_taiwan",n=as.numeric(n))



df_Azevedo_et_al_2022_taiwan_age <- df_Azevedo_et_al_2022_taiwan_age %>% 
  dplyr::full_join(Age_bins, by = "ageBins") %>% 
  dplyr::rename(n = 2, Proportion = 3, Data_Source = 4) %>% 
  dplyr::select(1:4) %>% 
  dplyr::mutate(n = ifelse(is.na(n),0,n),
                Proportion = ifelse(is.na(Proportion),0,Proportion),
                Data_Source = ifelse(is.na(Data_Source),"Azevedo_et_al_2022_taiwan",Data_Source))
