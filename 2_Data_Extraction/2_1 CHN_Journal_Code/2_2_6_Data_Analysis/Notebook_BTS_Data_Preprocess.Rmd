...
```{r}
load("BTS_dupli.Rdata")
```


all data.frame merge into one list
...
names(BTS[[18]])[names(BTS[[18]]) == "Country_now"] <- "Country"  ## BTS_Kowal 2018
...
Process countrycode to following analyse
```{r}
