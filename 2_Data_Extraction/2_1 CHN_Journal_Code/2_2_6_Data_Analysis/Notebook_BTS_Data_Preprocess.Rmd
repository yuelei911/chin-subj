...
BTS_Lucca_et_al_2024 <- BTS_Lucca_et_al_2024 %>% 
...
BTS[[6]] <- BTS[[6]] %>% 
  dplyr::mutate(Country = case_when(Country_region_name == "Aland Islands" ~  "Åland Islands",
                                     Country_region_name == "Antigua And Barbuda" ~ "Antigua & Barbuda",
                                     Country_region_name == "Bosnia And Herzegovina" ~ "Bosnia & Herzegovina",
                                     Country_region_name == "Brunei Darussalam" ~ "Brunei",
                                     Country_region_name == "Cote Divoire" ~ "Côte d’Ivoire",
                                     Country_region_name == "Czech Republic" ~ "Czechia",
                                     Country_region_name == "Democratic Peoples Republic of Korea" ~ "North Korea",
                                     Country_region_name == "Guinea-bissau" ~ "Guinea-Bissau",
                                     Country_region_name == "Heard Island And Mcdonald Islands" ~ "Heard & McDonald Islands",
                                     Country_region_name == "Holy See (Vatican City State)" ~ "Vatican City",
                                     Country_region_name == "Isle Of Man" ~ "Isle of Man",
                                     Country_region_name == "Lao Peoples Democratic Republic" ~ "Laos",
                                     Country_region_name == "Libyan Arab Jamahiriya" ~ "Libya",
                                     Country_region_name == "Macedonia" ~ "North Macedonia",
                                     Country_region_name == "Micronesia" ~ "Micronesia (Federated States of)",
                                     Country_region_name == "Palestinian Territory" ~ "Palestinian Territories",
                                     Country_region_name == "Republic of Korea" ~ "South Korea",
                                     Country_region_name == "Republic of Moldova" ~ "Moldova",
                                     Country_region_name == "Russian Federation" ~ "Russia",
                                     Country_region_name == "Saint Helena" ~ "St. Helena",
                                     Country_region_name == "Saint Kitts And Nevis" ~ "St. Kitts & Nevis",
                                     Country_region_name == "Saint Lucia" ~ "St. Lucia",
                                     Country_region_name == "Saint Pierre And Miquelon" ~ "St. Pierre & Miquelon",
                                     Country_region_name == "Saint Vincent And The Grenadines" ~ "St. Vincent & Grenadines",
                                     Country_region_name == "Sao Tome And Principe" ~ "São Tomé & Príncipe",
                                     Country_region_name == "South Georgia And The South Sandwich Islands" ~ "South Georgia & South Sandwich Islands",
                                     Country_region_name == "Svalbard And Jan Mayen" ~ "Svalbard & Jan Mayen",
                                     Country_region_name == "Swaziland" ~ "Eswatini",
                                     Country_region_name == "Syrian Arab Republic" ~ "Syria",
                                     Country_region_name == "The Democratic Republic Of The Congo" ~ "Congo - Kinshasa",
                                     Country_region_name == "Congo" ~ "Congo - Brazzaville",
                                     Country_region_name == "Trinidad And Tobago" ~ "Trinidad & Tobago",
                                     Country_region_name == "United States Minor Outlying Islands" ~ "United States Minor Outlying Islands (the)",
                                     Country_region_name == "Viet Nam" ~ "Vietnam",
                                     Country_region_name == "Wallis And Futuna" ~ "Wallis & Futuna",
                                     Country_region_name == "Faroe Islands" ~ "Faroe Islands",
                                     Country_region_name == "Reunion" ~ "Réunion",
                                     Country_region_name == "Falkland Islands (Malvinas)" ~ "Falkland Islands",
                                     Country_region_name == "Pitcairn" ~ "Pitcairn Islands",
                                     Country_region_name == "Turks And Caicos Islands" ~ "Turks & Caicos Islands",
                                    Country_region_name == "Hong Kong" ~ "Hong Kong SAR China",
                                    Country_region_name == "Macao" ~ "Macao SAR China",
                                     TRUE ~ Country_region_name))


# ## BTS_Bertolo_et_al_2023
BTS[[7]] <- BTS[[7]] %>%
  mutate(Country = case_when(Country == "Antigua and Barbuda" ~ "Antigua & Barbuda",
...
BTS[[8]] <- BTS[[8]] %>% 
  dplyr::mutate(Country = ifelse(Country == "USA", "United States",Country),
                ...
                Country = ifelse(Country == "England" | Country == "Northern Ireland" | Country == "Wales","United Kingdom",Country),
                Country = ifelse(Country == "SlovakRepublic", "Slovakia",Country))



## BTS_Buchanan_et_al_2023
BTS[[9]] <- BTS[[9]] %>% 
  dplyr::mutate(Country = ifelse(Country == "NA",NA,Country),
...
BTS[[15]] <- BTS[[15]] %>% 
  dplyr::mutate(Country = case_when(Country_region_name == "Aland Islands" ~  "Åland Islands",
                                    ...
                                    Country_region_name == "Hong Kong" ~ "Hong Kong SAR China",
                                    Country_region_name == "Macao" ~ "Macao SAR China",
                                    Country_region_name == "Myanmar" ~ "Myanmar (Burma)",
                                    Country_region_name == "Timor-leste" ~ "Timor-Leste",
                                    TRUE ~ Country_region_name))
...
BTS[[24]] <- BTS[[24]] %>% 
  ...
  dplyr::mutate(Country = case_when(Country == "babylabamsterdam" ~ "Netherlands",
                                    ...
                                    Country == "cogdevlabhku"  ~ "Hong Kong SAR China", ## this data is China Hongkong
                                    ...
                                    Country == "ellaauckland" ~ "New Zealand",
                                    Country == "princetonbabylab" ~ "United States",
                                    TRUE ~ Country))
...
BTS[[27]] <- BTS[[27]] %>% 
  dplyr::mutate(Country = trimws(Country),
                Country = ifelse(Country == "IRAN", "IRN", Country),
...
BTS[[30]] <- BTS[[30]] %>% 
  dplyr::mutate(Country = ifelse(Country == "the Netherlands", "Netherlands",Country),
                Country = ifelse(Country == "CHN","China",Country),
                Country = ifelse(Country == "georgia","Georgia",Country))
...
BTS <- BTS[-c(6,15)] ## remove data.frame with the country code as num (Bago et al 2022, Greenberg et al 2022)
```
...
BTS[[6]] <- BTS[[6]] %>% 
  dplyr::mutate(Education = as.character(Education),
                Education = case_when(Education == "1" ~ "Some elementary/middle school (primary school)",
...
## BTS_Psychological_Science_Accelerator_Self_Determination_Theory_Collaboration_2022
BTS[[25]] <- BTS[[25]] %>% 
  dplyr::mutate(Education = case_when(Education == "1" ~ "Less than high school",
                                      Education == "2" ~ "High school",
                                      Education == "3" ~ "Some college",
                                      Education == "4" ~ "Two year degree",
                                      Education == "5" ~ "Four year degree",
...
BTS_edu_list[[3]] <- BTS_edu_list[[3]] %>% 
  dplyr::mutate(Highschool = case_when(Education %in% c("Completed elementary/middle school (primary school)", 
                                                        "Some elementary/middle school (primary school)") ~ "Below_high_school",
                                       Education %in% c("Completed high school (secondary school)", 
                                                        "Some high school",
                                                        "Completed undergrad degree (~3-5 years higher education)",
                                                        "Some undergrad (higher education)",
                                                        "Completed graduate school",
                       "Some graduate school") ~ "High_school_and_above"),
                College = case_when(Education %in% c("Completed elementary/middle school (primary school)", 
                                                     "Some elementary/middle school (primary school)",
                                                     "Completed high school (secondary school)",
                                                     "Some high school") ~ "Below_college",
                                    Education %in% c("Completed undergrad degree (~3-5 years higher education)",
                                                     "Some undergrad (higher education)",
                                                     "Completed graduate school",
                                                     "Some graduate school") ~ "College_and_above"))
...
## BTS_Klein_et_al_2018_Slate2
BTS_edu_list[[12]] <- BTS_edu_list[[12]] %>% 
...
BTS_edu_list[[13]] <- BTS_edu_list[[13]] %>% 
  dplyr::mutate(Highschool = case_when(Education %in% c("Less than high school") ~ "Below_high_school",
                                       Education %in% c("High school",
                                                        "Some college", 
                                                        "Two year degree", 
                                                        "Four year degree", 
                                                        "Professional degree", 
                                                        "Doctorate") ~ "High_school_and_above"),
                College = case_when(Education %in% c("Less than high school", 
                                                     "High school") ~ "Below_college",
                                    Education %in% c("Some college",
                                                     "Two year degree",
                                                     "Four year degree", 
                                                     "Professional degree", 
                                                     "Doctorate") ~ "College_and_above"))
...
## BTS_Wang_et_al_2021 
BTS_edu_list[[18]] <- BTS_edu_list[[18]] %>%
