...
# ## merge edu list
# BTS_edu_twocate <- do.call(rbind,BTS_edu_list)
# 
# 
# ## trans edu
# BTS_edu_twocate <- BTS_edu_twocate %>% 
#   dplyr::mutate(College = case_when(Education == ))
# 
# ## Create a data.frame
# df <- data.frame(table(BTS_edu_twocate$Education))
```
