...
## Journal VS Census7
SupplH2_BF_gender_Journal_Census <- BayesMultiNomial(dataset = SupplH2_gender_general_bayes,
                                             factor = "Gender",
                                             observed = "Journal",
                                             expected = "Census7")
...
## BTS VS Census7
SupplH2_BF_gender_BTS_Census <- BayesMultiNomial(dataset = SupplH2_gender_general_bayes,
                                             factor = "Gender",
...
SupplH3_age_general <- ggplot(data= Census7_age_five5, 
...
ggsave("SupplH3_age_general.pdf",SupplH3_age_general, device = "pdf", width=18, height = 9)
...
## combine data
## PsyStages
Suppl_BF_PsyStages <- left_join(H1_PsyStages_bayes_general,
                                Suppl_Census7_age_PsyStages,
                                by = "ageBins")


## interval10
Suppl_BF_interval10 <- left_join(H1_interval10_bayes_general,
...
## BF
## BTS PsyStages
SupplH3_BF_Psystages_BTS_Census <- BayesMultiNomial(dataset = Suppl_BF_PsyStages,
                                             factor = "ageBins",
                                             observed = "BTS Chinese",
                                             expected = "Census7")
...
## BTS interval10
SupplH3_BF_interval10_BTS_Census <- BayesMultiNomial(dataset = Suppl_BF_interval10,
                                             factor = "ageBins",
                                             observed = "BTS Chinese",
                                             expected = "Census7")
...
## Journal PsyStages
SupplH3_BF_Psystages_Journal_Census <- BayesMultiNomial(dataset = Suppl_BF_PsyStages,
                                             factor = "ageBins",
                                             observed = "Journal",
                                             expected = "Census7")

## Journal interval10
SupplH3_BF_interval10_Journal_Census <- BayesMultiNomial(dataset = Suppl_BF_interval10,
                                             factor = "ageBins",
                                             observed = "Journal",
                                             expected = "Census7")
```
