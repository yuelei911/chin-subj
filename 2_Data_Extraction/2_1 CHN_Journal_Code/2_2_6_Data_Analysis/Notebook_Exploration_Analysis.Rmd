...
```{r}
# Fig_Journal_wordcloud <-  Journal_wordcloud_total + Journal_wordcloud2008 + 
#   Journal_wordcloud2018 + Journal_wordcloud2021 +
#   plot_layout(ncol = 2, nrow = 2, heights = c(2,2))+
#   plot_annotation(tag_levels = 'A',
#                   theme = theme(plot.title = element_text(size = 16))) + 
#   theme(plot.tag = element_text(size = 16))
# 
# # ggsave("Fig_Journal_wordcloud.pdf", Fig_Journal_wordcloud, device = "pdf", width=10, height = 6)
# 
# Fig_Journal_wordcloud
```