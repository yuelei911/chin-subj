...
## single region
Journal_region_studytype <- Journal %>% 
...
Journal_region_studytype2 <- Journal_region_studytype %>% 
  dplyr::filter(Target_Population_N != 1)



Journal_region_experi <- Journal_region_studytype2 %>% 
  dplyr::filter(Study_Type == 1)

Journal_region_questionaire <- Journal_region_studytype2 %>% 
  dplyr::filter(Study_Type == 2)
...
Journal_region_multiple_studytype <- Journal %>% 
...
continuing Journal region data 
```{r}
