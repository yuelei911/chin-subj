...
```{r}
Relaced_articles <- readxl::read_xlsx("D:\\chin-subj\\2_Data_Extraction\\2_1_CHN_Journal_Code\\2_1_5_Extract_Data\\2_5_5_3_Article_Replaced\\Chin_Subj_articles_replaced_CE.xlsx") %>% 
  dplyr::select(-rows) %>% 
