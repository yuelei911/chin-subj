...
file_list <- list.files(here("2_Data_Extraction","2_1_CHN_Journal_Code","2_1_5_Extract_Data","2_2_5_1_Article_Coding"),
  pattern = ".xlsx",
...
file_list <- list.files(here("2_Data_Extraction","2_1_CHN_Journal_Code","2_1_5_Extract_Data","2_2_5_2_Article_Proofreading"),
  pattern = ".xlsx",
  full.names = TRUE, recursive = TRUE)
...
```{r}
Relaced_articles <- readxl::read_xlsx("2_Data_Extraction","2_1_CHN_Journal_Code","2_1_5_Extract_Data","2_5_5_3_Article_Replaced","Chin_Subj_articles_replaced_CE.xlsx") %>% 
  dplyr::select(-rows) %>% 
...
## load BTS data
```{r}
BTS_CE <-  readxl::read_xlsx(here("2_Data_Extraction","2_2_BTS","Chin_Subj_Proofreading_BTS_Target_Population.xlsx"))
