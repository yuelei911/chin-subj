...
df_stage2_Journal_Code2$Subjects_Group_N[555] <- "海洛因戒断者组"

### Article_IDs 20082210
### Redundant Subjects Group
df_stage2_Journal_Code2$Subjects_Group[701:703] <- NA

### Article_IDs 20181023
df_stage2_Journal_Code2$Subjects_Group_N[790:793] <- df_stage2_Journal_Code2$Subjects_Group[790:793]

### Article_IDs 20182126
### Redundant Subjects Group
df_stage2_Journal_Code2$Subjects_Group[832:833] <- NA

### Article_IDs 20182131
df_stage2_Journal_Code2$Subjects_Group_N[834:835] <- df_stage2_Journal_Code2$Subjects_Group[834:835] 

### Article_IDs 20182118
### Redundant Subjects Group
df_stage2_Journal_Code2$Subjects_Group[824] <- "应激有害心向组"

### Article_IDs 20181078
df_stage2_Journal_Code2$Subjects_Group_N[1078] <- NA

### Article_IDs 20182192
df_stage2_Journal_Code2$Subjects_Group_N[1089] <- NA

### Article_IDs 20083017
df_stage2_Journal_Code2$Subjects_Group_N[1301:1302] <- df_stage2_Journal_Code2$Subjects_Group[1301:1302]
...
df_stage2_Journal_Code2$First_Author[1276] <- "冯冬冬"
df_stage2_Journal_Code2$Journal[1276] <- "心理学报"

### Article_IDs 20082379
df_stage2_Journal_Code2$First_Author[1295] <- "安秋玲" 
df_stage2_Journal_Code2$Journal[1295] <- "心理科学"

### Article_IDS 20184027
df_stage2_Journal_Code2$First_Author[1672:1673] <- "童钰" 
df_stage2_Journal_Code2$Journal[1672:1673] <- "心理发展与教育"

### Article_IDs 20213137
df_stage2_Journal_Code2$First_Author[1680] <- "王沛"
df_stage2_Journal_Code2$Journal[1680] <- "中国临床心理学杂志"

### Article_IDs 20213153
df_stage2_Journal_Code2$First_Author[1685] <- "王鸿飞"
df_stage2_Journal_Code2$Journal[1685] <- "中国临床心理学杂志"
...
df_stage2_Journal_Code2$Remark1[978] <- "secondary"

### Article_IDs 20182193
df_stage2_Journal_Code2$Remark1_N[1090] <- "mining"

### Article_ID 20213088
df_stage2_Journal_Code2$Remark1_N[224] <- "qualitative"

### Article_IDs 20182192
df_stage2_Journal_Code2$Remark1_N[1089] <- "qualitative"

### Article_IDs 20082029
df_stage2_Journal_Code2$Remark1_N[1488] <- "qualitative"
...
### Article_IDs 20082013
df_stage2_Journal_Code2$Remark1_N[1476] <- "secondary"

### Articel_IDs 20213305
df_stage2_Journal_Code2$Remark1[685] <- "inapplicable"
df_stage2_Journal_Code2$Remark1_N[685] <- "inapplicable"

### Article_IDs 200081055
df_stage2_Journal_Code2$Remark1[1281:1282] <- "inapplicable"
df_stage2_Journal_Code2$Remark1_N[1281:1282] <- "inapplicable"

### Article_IDs 20181039
df_stage2_Journal_Code2$Remark1[1027] <- "secondary"
...
### Article_IDs 20212103
df_stage2_Journal_Code2$Remark1[645] <- "inapplicable"
df_stage2_Journal_Code2$Remark1_N[645] <- "inapplicable"

### Article_IDs 20085023
df_stage2_Journal_Code2$Remark1[744] <- "secondary"

### Article_IDs 20213023
df_stage2_Journal_Code2$Remark1[1440] <- "mining"

### Article_IDs 20183360
df_stage2_Journal_Code2$Remark1[1577] <- "secondary"

### Article_IDs 20184029
df_stage2_Journal_Code2$Remark1[1589] <- "secondary" 
...
df_stage2_Journal_Code2$Remark2[784:785] <- ""

### Article_IDs 20185003
df_stage2_Journal_Code2$Remark2_N[899] <- ""
df_stage2_Journal_Code2$Remark2[900] <- "被试重复使用"
...
### Article_IDs 20182035 
df_stage2_Journal_Code2$Abstract1[556] <- 1

### Article_IDs 20085044
df_stage2_Journal_Code2$Abstract1[754:756] <- "1234b"

### Article_IDs 20181017
df_stage2_Journal_Code2$Abstract1[775:778] <- 0

### Article_IDs 20181022
df_stage2_Journal_Code2$Abstract1[784:789] <- 8

### Article_IDs 20181023
df_stage2_Journal_Code2$Abstract1[790:795] <- 1238

### Article_IDs 20182103
df_stage2_Journal_Code2$Abstract1[807:812] <- 123

### Article_IDs 20182125
df_stage2_Journal_Code2$Abstract1[827:831] <- 12345

### Article_IDs 20181028
df_stage2_Journal_Code2$Abstract1[1017:1020] <- 0

### Article_IDs 20181034
df_stage2_Journal_Code2$Abstract1[1023:1024] <- 0

### Article_IDs 20181037
df_stage2_Journal_Code2$Abstract1[1025:1026] <- 0

### Article_IDs 20181044
df_stage2_Journal_Code2$Abstract1[1029] <- 0

### Article_IDs 20181051
df_stage2_Journal_Code2$Abstract1[1030:1032] <- 0

### Article_IDs 20181052
df_stage2_Journal_Code2$Abstract1[1033:1034] <- 0

### Article_IDs 20181058
df_stage2_Journal_Code2$Abstract1[1035:1036] <- 0

### Article_IDs 20181061
df_stage2_Journal_Code2$Abstract1[1037:1039] <- 0

### Article_IDs 20181063
df_stage2_Journal_Code2$Abstract1[1040:1041] <- 0

### Article_IDs 20181065
df_stage2_Journal_Code2$Abstract1[1042:1045] <- 1

### Article_IDs 20181066
df_stage2_Journal_Code2$Abstract1[1046:1047] <- 0
...
### Article_IDs 20182103
df_stage2_Journal_Code2$Abstract2[807:812] <- 1
