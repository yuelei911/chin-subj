...
df_stage2_Journal_Code2 <- df_stage2_Journal_Code %>% 
  dplyr::mutate(Coder_N = if_else(is.na(Coder_N),"final",Coder_N))
...
df_indentification_Journal <- df_stage2_Journal_Code %>% 
...
df_stage2_Journal_Code2 <-  df_stage2_Journal_Code %>% 
  dplyr::mutate(First_Author = if_else(grepl("心理",First_Author),Journal,First_Author))
