...
### Subjects_Group_NA and Redundant Group
...
df_stage2_Journal_Code2$Female_Num[27] <- NA
df_stage2_Journal_Code2$Male_Num[27] <- NA
...
Age_detailed <- df_stage2_Journal_Code2 %>% 
  ...
  dplyr::filter(Age != 1)
df_stage2_Journal_Code2$Subjects_Group[5] <- NA
df_stage2_Journal_Code2$Subjects_Group_N[5] <- NA
df_stage2_Journal_Code2$M_age[5] <- NA
df_stage2_Journal_Code2$SD_age[5] <- NA
df_stage2_Journal_Code2$Other_age[5] <- NA

df_stage2_Journal_Code2$Subjects_Group[46] <- NA
df_stage2_Journal_Code2$Subjects_Group_N[46] <- NA
df_stage2_Journal_Code2$M_age[46] <- NA
df_stage2_Journal_Code2$SD_age[46] <- NA
df_stage2_Journal_Code2$Other_age[46] <- NA
